...
const ArrayListInformation = () => {
    return (
        <div className="information">
            <h1>Array List</h1>
            <p>An Array List is a resizeable array. It is one possible implementation of a List, an Abstract Data Type (ADT).</p>
            <br />
            ...
            <br />
            <p>Since the information in an array list is stored contiguously in an array, it benefits from random access. Consequently, operations such as accessing an element from a given index are very inexpensive. The trade off for this is that insertion and deletion become expensive operations since they require creating a new array and copying all elements over.</p>
